...
<!--          第二行-->
          <div style="font-size: 15px ; margin-top: 10px ;height: 22px">
            ...
            /*子标签*/
            margin-right: 7px;border: 1px solid grey;border-radius: 5px;">{{BasicInformation.categoryName}}</div>
          </div>
<!--          第三行-->
...
<!--          第四行-->
          ...
          <div style="margin-top: 15px">
            <el-button type="warning" round style="margin-right: 17px; color: #222" @click="read()"><b>开始阅读</b></el-button>
          ...
          <div class="BasicInformation-right">
            <el-card style="width: 260px;height: 191px">
                <div style="height: 65px;">
                  <div class="block"><el-avatar :size="60" :src="circleUrl" style="margin-top: 2px;float: left"></el-avatar></div>
                  <div style="padding: 10px 0 0 70px">
                    <b>{{ BasicInformation.author }}</b>
                    <br>
                    <div style="margin-top: 5px;margin-left: 4px">
                      <span style="background-color: #222222;color: #fce0b0 ;padding: 5px;border-radius: 13px;font-size: 14px">本书作者</span>
                    </div>
                  </div>
                </div>
...
<div style="margin-top: 20px;font-size: 24px">
  <b>作品介绍</b><el-divider></el-divider>
</div>
      <div>
